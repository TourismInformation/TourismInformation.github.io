...
<header class="masthead">
	<div class="container">
		...
		<div class="masthead-heading text-uppercase">Jelajahi Taman Nasional Komodo</div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">View DTW</a>
	</div>
</header>
<!-- Services-->
<section class="page-section bg-dark" id="home">
	<div class="container">
		<h2 class="text-center">DTW di Taman Nasional Komodo</h2>
			...
			<div class="col-md-4 p-4 ">
				<div class="card w-100 rounded-0">
					...
					<div class="w-100 d-flex justify-content-end">
						<a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning">View DTW <i class="fa fa-arrow-right"></i></a>
					</div>
					</div>
				</div>
			</div>
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=packages" class="btn btn-flat btn-warning mr-4">Explore TNK <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
<!-- About-->
